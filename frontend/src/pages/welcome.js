...
/*
        ...
        ifrm.setAttribute("src", "http://localhost:8090/oauth2/authorization/google");
        ifrm.style.width = "640px";
        ifrm.style.height = "480px";
        document.body.appendChild(ifrm);
*/

        //alert(Cookie.get('username', { domain: 'localhost:8090'})); // `domain` won't have any effect...!
  ...
  /*              axios.get(`http://localhost:8090/login/oauth2/code/get`, {
...
*/
    ...
    return (
        <div className="App">
<ModalExampleModal open={openModal} onClose={()=>{setOpenModal(false)}} onSubmit={(id)=>{
    getOrderInfoById(id).then((res) => {if(res.id==id){
