...
function Previews(props) {
    ...
    const {getRootProps, getInputProps} = useDropzone({
        ...
        onDrop: acceptedFiles => {
            ...
            //console.log(await fileUpload({fileType: "attachment", token: null}, acceptedFiles));
        }
    });
...
/*        for (const file of files) {
        ...
        for (const file of files) {
            ...
            //console.log(await fileUpload({fileType: "attachment", token: null}, file));
        }
    }, [files]);
                    ...
                    <div className="container pl-sm-5">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="flex-fill">
                                ...
                                <h3 className="font-weight-light text-left"><EditOutlinedIcon/> Подробное описание
                                    проблемы </h3>
