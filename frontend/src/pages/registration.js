...
function RegistrationPage() {
    ...
    const {authentication, registration, fileUpload, getUserInfo, checkAuth, logout, postOrder} = useBackendApi();
    const [textFieldsData, settextFieldsData] = useState({});
    useEffect(()=>{getUserInfo(undefined, false)},[]);
                            ...
                            <div className="col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div className="pt-3">
                                    <TextField id="input-with-icon-grid" label={<p>Логин</p>}
                                        ...
                                        settextFieldsData({...textFieldsData, ...{"login": e.target.value}})
                                    }}/>
                                    ...
                                    <TextField id="input-with-icon-grid" label={<p><KeyIcon/> &nbsp; Пароль</p>}
                                        ...
                                        settextFieldsData({...textFieldsData, ...{"passwordHash": e.target.value}})
                                    }}/>
...
*/}
                            ...
                            <div className="col-8">
                                ...
                                <Alert className={"mb-3 mt-3"} severity="warning" style={{textAlign: "left", width: "100%"}}>
                                    <AlertTitle>Рекомендуем</AlertTitle>
                                    <p>
                                        Наш будудующий пользователь, пожалуйста, ознакомься <strong style={{color:"rgb(102, 60, 0)"}}>внимательно</strong> с пользовательским соглашением!
                                    </p>
                                </Alert>
                                <div className={"text-left"} className="pt-3" style={{ maxHeight: "53em",
                                    overflow: "auto",
                                    padding: "1em" }}>

                                    <p style={{textAlign: "justify"}}>
                                        Настоящее Соглашение определяет условия использования Пользователями материалов и сервисов сайта www.Belgorod.CityAble.ru.
                                    </p>
                                    <p style={{textAlign: "justify"}}>
                                        1.Общие условия
                                    </p>
