...
import vkIcon from "../../public/resources/vk_icon.svg";
import googleIcon from "../../public/resources/google_icon.svg";
import Avatar from "@material-ui/core/Avatar";
import avatar from "../../public/resources/avatar.jpg";
...
export function UserAvatar(props: IUserInfo) {
    const {authentication, registration, fileUpload, getUserInfo} = useFrontendApi();
                ...
                <Row>
                    {/*{userInfo.socialLink&&props.withlinks&&userData.socialLink.map(s =>
                            <Popup content={`${s.socialType.endpoint.replace("%",s.payload)}`}
                                ...
                                <NextImage src={s.socialType.logoUrl} style={{width: "2em"}}/>
...
*/}
                    ...
                    {/*                    <IconButton style={{width: "1em", height: "1em", padding: "0"}} color="primary"
                        ...
                        <NextImage src={vkIcon} style={{width: "2em"}}/>
                    </IconButton>
                    <IconButton style={{width: "1em", height: "1em", padding: "0"}} color="primary"
                                aria-label="add to shopping cart">
                        <NextImage src={googleIcon} style={{width: "2em"}}/>
                    </IconButton>*/}
...
*/}
        ...
        >
            {props.clickable?<Link href={`/profile/${userData&&userData.id}`}>
